...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["delete"])) {
        $id = $_POST["id"];
        $query = "DELETE FROM dailyupdatesmedication WHERE id = $id";
    ...
    $query = "INSERT INTO dailyupdatesmedication (datetime, proof, description, status) VALUES ('$datetime', '$proofDestination', '$description', '$status')";
    mysqli_query($conn, $query);
    exit();
}
