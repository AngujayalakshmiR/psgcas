...
$query = "SELECT ID, datetime, proof, status, description FROM dailyupdatesmedication ORDER BY ID DESC";
...
<div class="card shadow mb-4">
    ...
    color: rgb(23, 25, 28);
    font-size: 16px;
    font-weight: 500;"><b>Medication Updates</b>  <!-- Counter next to heading -->
        </p>
    </div>
    <div class="card-body">
