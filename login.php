  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="img/Login.jpg" class="img-fluid" alt="Login Image">
      </div>
      ...
      <form id="loginForm">
        ...
        <div class="form-outline mb-4">
          <input type="text" id="username" class="form-control form-control-lg" placeholder="Enter valid username" autocomplete="username" required />
        </div>

        <label>Enter Password:</label>
        <div class="form-outline mb-3">
          <input type="password" id="password" class="form-control form-control-lg" placeholder="Enter valid password" autocomplete="current-password" required />
        </div>
...
document.addEventListener("DOMContentLoaded", function() {
  document.getElementById("loginForm").addEventListener("submit", function(event) {
    ...
    // Define valid credentials and their redirection pages
    const credentials = {
      "d": "doctordashboard.php",
      "f": "dailyupdatefamily.php",
      "n": "nursedashboard.php",
      "r": "patientcreation.php"
    };

    // Validate username and password
    if (credentials[username] && password === username) {
      window.location.href = credentials[username]; // Redirect to respective page
    } else {
