...
<div class="column">
    ...
    <form id="customerForm" class="row g-3 mt-3">
        <div class="col-md-4 pb-1">
            <input type="text" class="form-control mb-2" id="doctorname" name="doctorname" placeholder="Enter Doctor Name" required>
            <input type="text" class="form-control mb-2" id="spl" name="spl" placeholder="Enter Specialization" required>
        </div>

        <div class="col-md-4 pb-1">
        <input type="text" class="form-control mb-2" id="exp" name="exp" placeholder="Enter Experience" required>
