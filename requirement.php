...
<script>
    ...
    function fetchRequirementFile() {
        ...
        fetch(`fetch_requirement.php?company=${encodeURIComponent(companyName)}&title=${encodeURIComponent(projectTitle)}`)
            ...
            .then(data => {
                if (data.reqfile) {
                    let fileBox = createFileBox(data.reqfile, false);
            ...
            .catch(error => console.error("Error fetching requirement file:", error));
    }
    ...
    function renderFiles() {
        ...
        storedFiles.forEach((fileName, index) => {
            ...
            let fileBox = createFileBox(fileName, true, index);
            currentRow.appendChild(fileBox);
        });
    }
    ...
    function deleteFile(fileIndex) {
        let fileName = storedFiles[fileIndex];
